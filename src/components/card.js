...
export const addCard = (cardData) => {
  const card = cardData.cardTemplate.querySelector('.places__item').cloneNode(true);
  ...
  cardLikeBtn.addEventListener('click', (event) => {
    cardData.isLikeCard(event, cardData.putLikeApi, cardData.deleteLikeApi, cardLikeCounter);
  });
...
export const isLikeCard = (event, putLikeApi, deleteLikeApi, cardLikeCounter) => {
